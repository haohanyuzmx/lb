...
func (in *VMSpec) DeepCopyInto(out *VMSpec) {
	*out = *in
	if in.VirtualServers != nil {
		...
		*out = make([]VirtualServerInfo, len(*in))
		copy(*out, *in)
	}
	if in.NICs != nil {
		in, out := &in.NICs, &out.NICs
		*out = make([]util.NamespacedName, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualServerInfo) DeepCopyInto(out *VirtualServerInfo) {
	*out = *in
	out.Index = in.Index
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualServerInfo.
func (in *VirtualServerInfo) DeepCopy() *VirtualServerInfo {
	if in == nil {
		return nil
	}
	out := new(VirtualServerInfo)
	in.DeepCopyInto(out)
	return out
}
